...
{
    public partial class frmInputer : Form
    {
        ...
        private static frmInputer current = null;

        public static frmInputer Current { get { return current; } }
        ...
        public frmInputer()
        {
            ...
            this.Disposed += FrmInputer_Disposed;
        }
        ...
        private void FrmInputer_Disposed(object sender, EventArgs e)
        {
            if (RpthList != null) RpthList.Close();
        }
