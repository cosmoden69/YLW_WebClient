...
{
    public class ObjectToolArrow : ObjectToolCreatorBase
    {
        public ObjectToolArrow(MySheet sheet) : base(sheet)
        {
        ...
        public override void OnMouseDown(MouseEventArgs e)
        {
            ...
            { 
                int num = e.X;
                int num2 = e.Y;
                base.AddNewObject(new ObjectArrow(_sheet, num, num2, num + 1, num2 + 1));
            }
            catch { }
        }
