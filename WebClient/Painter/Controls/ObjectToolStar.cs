...
{
    public class ObjectToolStar : ObjectToolCreatorBase
    {
        public ObjectToolStar(MySheet sheet) : base(sheet)
        {
        ...
        public override void OnMouseDown(MouseEventArgs e)
        {
            ...
            { 
                int num = e.X;
                int num2 = e.Y;
                base.AddNewObject(new ObjectStar(_sheet, num, num2, num + 1, num2 + 1));
            }
            catch { }
        }
        ...
        public override void OnMouseMove(MouseEventArgs e)
        {
            ...
            { 
                ...
                if ((e.Button == MouseButtons.Left) && (_sheet.ActiveObjectCreator != ObjectCreatorType.None))
                {
                    ...
                    _sheet.ObjectList[0].MoveHandleTo(point, 5);
                    _sheet.Refresh();
                }
            }
            catch { }
