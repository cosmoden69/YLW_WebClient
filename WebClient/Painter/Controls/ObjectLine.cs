...
namespace YLW_WebClient.Painter.PaintControls
{
    ...
    public class ObjectLine : ObjectBase
    {
        ...
        public ObjectLine(MySheet sheet) : this(sheet, 0, 0, 1, 0)
        {
        }

        public ObjectLine(MySheet sheet, int x1, int y1, int x2, int y2) : base(sheet)
        {
        ...
        {
            ObjectLine objectBase = new ObjectLine(base.ObjectSheet);
