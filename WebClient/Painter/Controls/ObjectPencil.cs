...
{
    [Serializable]
    public class ObjectPencil : ObjectLine
    {
        private List<ObjectPoint> _PointList;

        public ObjectPencil(MySheet sheet) : base(sheet)
        {
            this._PointList = new List<ObjectPoint>();
        }

        public ObjectPencil(MySheet sheet, int x1, int y1, int x2, int y2) : base(sheet)
        {
            this._PointList = new List<ObjectPoint>();
        ...
        {
            ObjectPencil objectBase = new ObjectPencil(base.ObjectSheet);
