...
{
    public partial class mrtzContractA : UserControl, IComparable
    {
        ...
        public string InsurKeepCd
        {
            get
            {
                return Utils.GetComboSelectedValue(cbo_no00_06, "MinorSeq");
            }
            set
            {
                Utils.SetComboSelectedValue(cbo_no00_06, value, "MinorSeq");
            }
        }
        public string InsurKeepCdNm
        {
            get
            {
                return Utils.GetComboSelectedValue(cbo_no00_06, "MinorName");
            }
        }
        ...
        private mrtzContract _parentC = null;
        private bool readOnlyMode = false;
        private bool _bEvent = false;

        public mrtzContractA(mrtzContract p, bool newrow = false)
        {
            this._parentC = p;
            ...
            this.cbo_no00_06.SelectedIndexChanged += Combo_SelectedIndexChanged;
            this.cbo_no00_06.MouseWheel += Combo_MouseWheel;
            this.btn_no00_01.Click += new System.EventHandler(this.Button_Click);
            this.Load += MrtzContractA_Load;

            _bEvent = true;
        }

        private void MrtzContractA_Load(object sender, EventArgs e)
        {
        }
        ...
        public void Init_Set(DataTable pdt)
        {
            try
            {
                ...
                Utils.SetCombo(cbo_no00_06, pdt.Copy(), "MinorSeq", "MinorName", true);
        ...
        public void SetReadOnlyMode(bool rdonly)
        {
            ...
            this.cbo_no00_06.SetReadOnly(rdonly);
        ...
        public int CompareTo(object obj)
        {
            ...
            mrtzContractA other = obj as mrtzContractA;
            if (other != null)
            {
