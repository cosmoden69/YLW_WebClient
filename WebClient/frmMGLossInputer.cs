...
{
    public partial class frmMGLossInputer : Form
    {
        ...
        private static frmMGLossInputer current = null;

        public static frmMGLossInputer Current { get { return current; } }

        private FrmRptHistoryList RpthList = null;

        public frmMGLossInputer()
        {
            InitializeComponent();
            ...
            this.Disposed += frmMGLossInputer_Disposed;
        }
        ...
        private void frmMGLossInputer_Disposed(object sender, EventArgs e)
        {
            if (RpthList != null) RpthList.Close();
        }
