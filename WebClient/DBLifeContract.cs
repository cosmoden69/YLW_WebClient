...
{
    public partial class DBLifeContract : UserControl
    {
        public miDBLifeContractRows Rows = null;

        private bool readOnlyMode = false;
        private DataTable gdt = null;

        public DBLifeContract()
        {
            InitializeComponent();

            this.Rows = new miDBLifeContractRows(this);
        }
        ...
        public DBLifeContractA AddEmptyRow()
        {
            DBLifeContractA item;
        ...
        public DBLifeContractA AddRow(DataRow drow)
        {
            DBLifeContractA item;
            int tabindex = (this.Rows.LastRow != null ? this.Rows.LastRow.TabIndex : 0);
        ...
        public void RemoveRow(DBLifeContractA item)
        {
        ...
        public void Sort()
        {
            this.Rows.Sort(new DBLifeContractAComp());
            this.RefreshControl();
        }
    ...
    public class miDBLifeContractRows
    {
        public int Count { get { return _list.Count; } }
        public DBLifeContractA FirstRow
        {
            get
            {
        ...
        public DBLifeContractA LastRow
        {
            get
            {
                if (this._list.Count < 1) return null;
        ...
        public DBLifeContractA EmptyRow { get; set; } = null;

        private DBLifeContract _view = null;
        private List<DBLifeContractA> _list = null;

        public miDBLifeContractRows(DBLifeContract vw)
        {
            this._view = vw;
            this._list = new List<DBLifeContractA>();
        }

        public DBLifeContractA this[int index]
        {
            get
            {
        ...
        public DBLifeContractA Add(bool newrow = false)
        {
            DBLifeContractA var = new DBLifeContractA(_view, newrow);
            _list.Add(var);
            return var;
        }

        public DBLifeContractA Insert(int idx)
        {
            DBLifeContractA var = new DBLifeContractA(_view);
        ...
        public void Remove(DBLifeContractA item)
        {
            _list.Remove(item);
        }

        public void Sort(IComparer<DBLifeContractA> comp)
        {
            _list.Sort(comp);
        }
    }

    public class DBLifeContractAComp : IComparer<DBLifeContractA>
    {
        // Compares by Height, Length, and Width.
        public int Compare(DBLifeContractA x, DBLifeContractA y)
        {
