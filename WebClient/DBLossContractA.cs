...
{
    public partial class DBLossContractA : UserControl, IComparable
    {
        ...
        private DBLossContract _parentC = null;
        private bool readOnlyMode = false;
        private bool _bEvent = false;

        public DBLossContractA(DBLossContract p, bool newrow = false)
        {
            this._parentC = p;
            ...
            this.Load += DBLossContractA_Load;

            _bEvent = true;
        }

        private void DBLossContractA_Load(object sender, EventArgs e)
        {
        }
        ...
        public int CompareTo(object obj)
        {
            ...
            DBLossContractA other = obj as DBLossContractA;
            if (other != null)
            {
