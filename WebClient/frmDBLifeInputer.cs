...
{
    public partial class frmDBLifeInputer : Form
    {
        ...
        private static frmDBLifeInputer current = null;

        public static frmDBLifeInputer Current { get { return current; } }

        private FrmRptHistoryList RpthList = null;

        public frmDBLifeInputer()
        {
            InitializeComponent();
        ...
        private void frmDBLifeInputer_Disposed(object sender, EventArgs e)
        {
            if (RpthList != null) RpthList.Close();
        }
        ...
        private void btn_Find_Click(object sender, EventArgs e)
        {
            ...
            dr["DcmgDocNo"] = "";
            dr["ReportType"] = ucInputer1.param.ReportType;
