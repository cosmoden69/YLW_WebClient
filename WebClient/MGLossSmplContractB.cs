...
{
    public partial class MGLossSmplContractB : UserControl, IComparable
    {
        public delegate void MGCntrBResizeEventHandler(object sender, ContentsResizedEventArgs e);

        public event MouseEventHandler MGLossSmplContractBMouseWheel;
        public event MGCntrBResizeEventHandler MGLossSmplContractBResize;
        public event EventHandler MGLossSmplContractBPriceChanged;
        ...
        public MGLossSmplContractB(MGLossSmplContractA p, bool newrow = false)
        {
            this._parentC = p;
        ...
        private void PriceChange(object sender, EventArgs e)
        {
            ...
            if (this.MGLossSmplContractBPriceChanged != null) this.MGLossSmplContractBPriceChanged(this, e);
        }

        private void Txt_ContentsMouseWheel(object sender, MouseEventArgs e)
        {
            if (this.MGLossSmplContractBMouseWheel != null) this.MGLossSmplContractBMouseWheel(this, e);
        }
        ...
        private void Txt_ContentsResized(object sender, ContentsResizedEventArgs e)
        {
            ...
            this.PerformLayout();
            if (this.MGLossSmplContractBResize != null) this.MGLossSmplContractBResize(this, e);
        }
        ...
        public int CompareTo(object obj)
        {
            ...
            MGLossSmplContractB other = obj as MGLossSmplContractB;
            if (other != null)
            {
                return 0;
            }
