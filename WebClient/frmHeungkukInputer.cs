...
{
    public partial class frmHeungkukInputer : Form
    {
        ...
        private static frmHeungkukInputer current = null;

        public static frmHeungkukInputer Current { get { return current; } }

        private FrmRptHistoryList RpthList = null;

        public frmHeungkukInputer()
        {
            InitializeComponent();
            ...
            this.Disposed += FrmHeungkukInputer_Disposed;
        }
        ...
        public static bool ShowPreview()
        {
            try
            {
                ...
                {
                    current = new frmHeungkukInputer();
                    current.Top = 0;
                    current.Left = 0;
        ...
        private void FrmHeungkukInputer_Disposed(object sender, EventArgs e)
        {
            if (RpthList != null) RpthList.Close();
        }
