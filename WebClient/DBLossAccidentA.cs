...
{
    public partial class DBLossAccidentA : UserControl, IComparable
    {
        ...
        private DBLossAccident _parentC = null;
        private bool readOnlyMode = false;

        public DBLossAccidentA(DBLossAccident p, bool newrow = false)
        {
            this._parentC = p;
            ...
            this.txtVstHosp.rtbDoc.TextChanged += new System.EventHandler(this.Text_Change);
            ...
            manager.AddControl(0, dtiCureFrDt, txtCureCnts, txtVstHosp, panelEx18);
        }
        ...
        public int CompareTo(object obj)
        {
            ...
            DBLossAccidentA other = obj as DBLossAccidentA;
            if (other != null)
            {
