...
{
    public partial class DBLifeAccidentA : UserControl, IComparable
    {
        ...
        public string CureFrDt
        {
            ...
            set
            {
                ...
                lblno00_01.Text = (value == "" || value == "00010101" ? "-" : Utils.DateFormat(value, "yyyy-MM-dd"));
            }
        }
        ...
        public string VstHosp
        {
            ...
            set
            {
                ...
                lblno00_04.Text = txtVstHosp.Text;
            }
        }
        ...
        private DBLifeAccident _parentC = null;
        private bool readOnlyMode = false;

        public DBLifeAccidentA(DBLifeAccident p, bool newrow = false)
        {
            this._parentC = p;
        ...
        private void Txt_ContentsResized(object sender, ContentsResizedEventArgs e)
        {
            ...
            this.dtiCureFrDt.MinimumSize = new Size(0, hgt);
            this.dtiCureFrDt.Height = hgt;
            this.dtiCureToDt.MinimumSize = new Size(0, hgt);
            this.dtiCureToDt.Height = hgt;
            this.txtVstHosp.MinimumSize = new Size(0, hgt);
            this.txtVstHosp.Height = hgt;
            this.txtCureCnts.SetContentsHeight(hgt);
        ...
        public int CompareTo(object obj)
        {
            ...
            DBLifeAccidentA other = obj as DBLifeAccidentA;
            if (other != null)
            {
