...
{
    public partial class frmLinaInputer : Form
    {
        ...
        private static frmLinaInputer current = null;

        public static frmLinaInputer Current { get { return current; } }

        private FrmRptHistoryList RpthList = null;

        public frmLinaInputer()
        {
            InitializeComponent();

            this.Resize += FrmLinaInputer_Resize;
            this.Disposed += FrmLinaInputer_Disposed;
        }
        ...
        private void FrmLinaInputer_Disposed(object sender, EventArgs e)
        {
            if (RpthList != null) RpthList.Close();
        }
        ...
        private void Btn_Print_Click(object sender, EventArgs e)
        {
            ...
            string ReportName = "DlgAdjSLSurvRptLina";  //--인보험(종결보고서)
        ...
        private void FrmLinaInputer_Resize(object sender, EventArgs e)
        {
