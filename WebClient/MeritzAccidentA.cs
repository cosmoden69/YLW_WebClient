...
{
    public partial class MeritzAccidentA : UserControl, IComparable
    {
        ...
        private MeritzAccident _parentC = null;
        private bool readOnlyMode = false;

        public MeritzAccidentA(MeritzAccident p, bool newrow = false)
        {
            this._parentC = p;
        ...
        public int CompareTo(object obj)
        {
            ...
            MeritzAccidentA other = obj as MeritzAccidentA;
            if (other != null)
            {
