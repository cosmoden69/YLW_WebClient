...
{
    public partial class MGLossSmplAccidentA : UserControl, IComparable
    {
        ...
        private MGLossSmplAccident _parentC = null;
        private bool readOnlyMode = false;

        public MGLossSmplAccidentA(MGLossSmplAccident p, bool newrow = false)
        {
            this._parentC = p;
            ...
            this.txtCureCnts.TextChanged += new System.EventHandler(this.Text_Change);
            ...
            manager.AddControl(0, txtGubunName, dtiCureFrDt, txtCureCnts, txtVstHosp, panelEx18);
        ...
        public void SetReadOnlyMode(bool rdonly)
        {
            ...
            this.txtCureCnts.rtbDoc.ReadOnly = rdonly;
        ...
        public int CompareTo(object obj)
        {
            ...
            MGLossSmplAccidentA other = obj as MGLossSmplAccidentA;
            if (other != null)
            {
