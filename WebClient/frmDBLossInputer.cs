...
{
    public partial class frmDBLossInputer : Form
    {
        ...
        private static frmDBLossInputer current = null;

        public static frmDBLossInputer Current { get { return current; } }

        private FrmRptHistoryList RpthList = null;

        public frmDBLossInputer()
        {
            InitializeComponent();

            this.Disposed += FrmDBLossInputer_Disposed;
        }
        ...
        private void FrmDBLossInputer_Disposed(object sender, EventArgs e)
        {
            if (RpthList != null) RpthList.Close();
        }
