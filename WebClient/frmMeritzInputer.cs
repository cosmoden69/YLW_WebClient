...
{
    public partial class frmMeritzInputer : Form
    {
        ...
        private static frmMeritzInputer current = null;

        public static frmMeritzInputer Current { get { return current; } }

        private FrmRptHistoryList RpthList = null;

        public frmMeritzInputer()
        {
            InitializeComponent();

            this.Disposed += FrmMeritzInputer_Disposed;
        }
        ...
        private void FrmMeritzInputer_Disposed(object sender, EventArgs e)
        {
            if (RpthList != null) RpthList.Close();
        }
