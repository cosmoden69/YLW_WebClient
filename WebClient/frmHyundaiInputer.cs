...
{
    public partial class frmHyundaiInputer : Form
    {
        ...
        private static frmHyundaiInputer current = null;

        public static frmHyundaiInputer Current { get { return current; } }

        private FrmRptHistoryList RpthList = null;

        public frmHyundaiInputer()
        {
            InitializeComponent();

            this.Disposed += FrmHyundaiInputer_Disposed;
        }
        ...
        private void FrmHyundaiInputer_Disposed(object sender, EventArgs e)
        {
            if (RpthList != null) RpthList.Close();
        }
