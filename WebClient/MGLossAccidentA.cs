...
{
    public partial class MGLossAccidentA : UserControl, IComparable
    {
        ...
        private MGLossAccident _parentC = null;
        private bool readOnlyMode = false;

        public MGLossAccidentA(MGLossAccident p, bool newrow = false)
        {
            this._parentC = p;
            ...
            manager.AddControl(0, txtGubunName, dtiCureFrDt, dtiCureToDt, txtCureCnts, txtVstHosp, panelEx18);
        ...
        public int CompareTo(object obj)
        {
            ...
            MGLossAccidentA other = obj as MGLossAccidentA;
            if (other != null)
            {
                int CompareResult = this.CureFrDt.CompareTo(other.CureFrDt);
                if (CompareResult == 0)
                {
                    CompareResult = this.CureToDt.CompareTo(other.CureToDt);
                    if (CompareResult == 0)
                    {
